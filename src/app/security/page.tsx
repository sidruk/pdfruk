  ...
  return (
    <StaticPageShell>
      <p>
        ...
        device. All of our free online PDF tools run entirely in your browser
        using client-side JavaScript — files are not uploaded to our servers for{" "}
      ...
      <p>
        When you use pdfruk, your PDF is read and processed in memory inside
        your browser. The result is generated locally and downloaded directly to
        your device. We do not receive, store, or retain those files — making
        pdfruk one of the most private ways to work with PDFs online.
      </p>
      ...
      <p>
        Because processing happens on your device, you remain in control of what
        you process. Use pdfruk on trusted devices, keep your browser updated, and avoid processing highly sensitive
